...
# Empirical data dictionary for key variables
# Goal: understand distributions, missingness, and coding before modeling.
...
important_vars <- c(
  ...
  "TNM_CLIN_STAGE_GROUP", "ANALYTIC_STAGE_GROUP",
...
# keep only variables that actually exist in this extract
...
message(" - data/processed/data_dictionary.csv")
