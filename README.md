...
Table 1 → model/table1_cohort_characteristics.csv
Table 2 → model/table2_multivariable_cox.csv
Table 3 → model/table3_model_performance.csv
Figures 1–3 → model/calibration_*_simple.png
Figure 4 → model/example_survival_curves.png
Model object → model/cox_simple_fit.rds
